...
const dailyProgress = { 
    todaysProgress: () => { 
        ...
        let previous = new Date(today.getFullYear(), 0, 1); 
        let progress = Math.ceil( ((current - previous + 1) / 86400000 ) / 365 * 100); 
        return progress; 
    }
}
...
//# sourceMappingURL=vendor.7fe4b956759fd2ffdde3.js.map